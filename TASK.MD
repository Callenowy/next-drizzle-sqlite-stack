...
- 🔒 Implement login ``POST ::REDACTED FOR PRIVACY::``
...
Please follow the provided design 👈. We're looking for accurate implementation of the design and attention to detail.
...
Once you have finished the task, please let your recruiter know. They will then assign a developer to start the review process (which typically takes 1-2 days). After that, the recruiter will share full feedback with you.
